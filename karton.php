...
<div class="bt">
    ...
    <div class="container">
        ...
        <div class="disline">
            <h2 class="textColorProfile">Dodaj karton za
                <?php  $id = $_GET['id_pacijent'];  $user = get_user($id); echo $user['firstname'] . ' ' . $user['lastname']  ?>
        ...
        //    $query = "SELECT * FROM pregled WHERE id_pacijent = $id AND datum = '$datum'";
                ...
                // echo $datum;
            ?>
            <?php   if($pregled_id == $id_karton_pregled) {?>
            <div class="col-6">
            ...
            <?php    } else {
             ...
             if($result->num_rows > 0) {
                 ...
                 while($row = $result->fetch_assoc()) {
                     ...
                     foreach($result as $karton) { 
                         $pregled = get_pregled($pregled_id);
                     $datum = $pregled['datum'];
                     $vreme = $pregled['vreme'];
                     $vremee = substr($vreme,0,5 );
                ...
                echo " <form method='POST'>
                    ...
                    <input type='text' id='fnamee' disabled value='$datum $vremee h 'h' h>
