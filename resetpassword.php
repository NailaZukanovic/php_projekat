...
<div class="container">
    <div class="row">
        ...
        <h1 class="text-center textColorProfile">Zaboravili ste lozinku?</h1>
        <h1 class="text-center textColorProfile">Unesite Vaš E-mail <i class="fa-solid fa-circle-arrow-down"></i></h1>
        <div class="resetpage-flex">
            <form method='POST'>
                ...
                <input type='submit' value='Pošaljite zahtev'>
            </form>
        </div>
