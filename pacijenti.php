                ...
                <div class="col-6">
                    ...
                    <div class="disline">
                        <ul class="navigationpacijent">
                            <li class="activevaslekar"><a href="pacijenti.php">Pacijenti</a></li>
                    ...
                    <div class="disline">
                        <h2 class="textColorProfile">Pacijenti koji imaju zakazan termin <i
                                class="fa-solid fa-down-long"></i></h2>
                    </div>
                    ...
                    <table id="customers">
                        ...
                        <tr>
                            <?php
               display_pacijent_pregled($user_id);
